...
<h2 style="position:relative; color: white;">Evaluation Questions and Answers</h2>
...
<div>
	<h4 style="position:relative; color: white;">Questions And Answers for <span style=" font-size: 1.5em;"><%= course.getName()%></span></h4>
</div><br/><br/>
...
<div id="panel" class="panel panel-info">
  ...
  <div class="container-fluid panel-body">
  	<form method="post" action="<%= request.getContextPath() + "/AssignQuestion?id=" + course.getId() %>">
  	<div class="row">
  	...
  	<div class="row">
  		...
  		<div class="col-md-9"><input style="width: 100%;" type="text" name="question" required placeholder="Write down your Question..." /> </div>
  	</div>
  	<hr/>
  	<div class="row">
  		<div class="col-md-3" style="font-weight: bold;">Answers</div>
  		<div class="col-md-9"><input style="width: 100%;" type="text" name="answer" required placeholder="answer1, answer2, answer3..." /> </div><br/><br/>
